...
inline const char *determinePathToData(const char *userSelectedPath = NULL)
{
  ...
  // return "/Users/tobi/Documents/Data Engineering/CS107/Assignments/Assignment_2/assn-2-six-degrees-data/little-endian/";
  // if (strcasecmp(ostype, "solaris") == 0)

  // This is the path on my computer. Replace it with the path to the assignment on your computer. 
    return "/Users/tobi/Documents/Data Engineering/CS107/Assignments/Assignment_2/assn-2-six-degrees-data/updated/little-endian/";
